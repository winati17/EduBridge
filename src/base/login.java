 ...
 */
 ...
 /*
 * Kelas ini merupakan bagian dari package 'base' dan digunakan untuk menangani proses login.
 * 
 * Fungsi:
 * - Mengecek kredensial pengguna (username dan password) dengan memanfaatkan kelas MuridDao.
 * - Jika kredensial valid, membuka halaman utama (Homepage).
 * - Jika kredensial tidak valid, menampilkan pesan kesalahan.
 * - Menangani juga proses pendaftaran dengan mengarahkan ke RegisterPage.
 */
package base;
...
public class Login extends javax.swing.JFrame {
     ...
     */
    // Metode untuk menginisialisasi komponen GUI dimana kode dihasilkan oleh NetBeans
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        try {
            // Membuat objek MuridDao
            muridDao = new MuridDao();
            // Mendapatkan informasi email dan password dari GUI
            System.out.println(tf_email.getText() + " " + String.valueOf(tf_password.getPassword()));
            // Memeriksa kredensial dengan menggunakan MuridDao
